...
function MobFactory() {
	...
	this.create = function() {
		...
		if(randomIndex == 0) randomMob = {key: "wild-boar", name: "Wild boar", level:1, baseHp:20, hp:20, minAtk:1, maxAtk:4, ac:1,  regen:0, luck:2, atkTypes:["melee"], xp:15, copper:6, items:[item]};
		if(randomIndex == 1) randomMob = {key: "cave-troll", name: "Cave troll", level:1, baseHp:80, hp:80, minAtk:4, maxAtk:10, ac:5,  regen:3, luck:2, atkTypes:["melee"], xp:500, copper:500, items:[item]};		
		if(randomIndex == 2) randomMob = {key: "leech", name: "Leech", level:1, baseHp:22, hp:22, minAtk:1, maxAtk:3, ac:0,  regen:1, luck:2, atkTypes:["melee"], xp:7, copper:4, items:[item]};
		if(randomIndex == 3) randomMob = {key: "rat", name: "Rat", level:1, baseHp:12, hp:12, minAtk:1, maxAtk:2, ac:0,  regen:1, luck:2, atkTypes:["melee", "poison I"], xp:5, copper:2, items:[item]};
		if(randomIndex == 4) randomMob = {key: "giant-spider", name: "Giant spider", level:1, baseHp:36, hp:36, minAtk:3, maxAtk:6, ac:3,  regen:1, luck:2, atkTypes:["melee", "poison I"], xp:95, copper:100, items:[item]};
		if(randomIndex == 5) randomMob = {key: "troll", name: "Troll", level:1, baseHp:65, hp:65, minAtk:3, maxAtk:8, ac:4,  regen:2, luck:2, atkTypes:["melee"], xp:300, copper:360, items:[item]};
