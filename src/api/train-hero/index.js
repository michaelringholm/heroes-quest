...
exports.handler = async function(event, context, callback) {
    ...
    try {
        ...
        var trainingResult = await hero.train(loginDTO.userGuid, heroDTO.heroKey);
        ...
        HttpController.respondOK(origin, {hero:heroDTO,location:location,trainingResult:trainingResult}, callback);
    }
    catch(ex) { HttpController.respondError(origin, 500, "Failed to train character:"+ex, callback); return; }
};
